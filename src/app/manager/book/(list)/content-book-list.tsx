...
import { storeBookListManger } from '@/working-manager/book/book-manager-store'
import BookManagerCard from './book-manager-card'
...
export default function ContentBookList() {
    ...
    const { data, loading } = storeBookListManger()
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2 text-sm sm:text-base">
                        Xem và quản lý tất cả sách và giáo trình của giảng viên
                    </p>
                </div>
            </div>
