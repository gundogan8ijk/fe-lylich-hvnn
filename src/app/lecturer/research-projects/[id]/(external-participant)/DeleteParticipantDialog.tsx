...
export default function DeleteParticipantDialog({ participantId, name, loading, onClose, onConfirm }: Props) {
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl w-full max-w-sm border border-slate-200 dark:border-slate-700">
                ...
                <div className="px-5 pb-5">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                        Bạn có chắc chắn muốn xóa <strong className="text-slate-800 dark:text-slate-200">"{name}"</strong> khỏi đề tài?
                    </p>
                </div>
