...
import { MemberListResponse } from '@/discipline-Manager/discipline-manger-type';
import { ListQuery, SortDirection } from '@/_Common/_types/query-types';
import { getListMemberByDisciplineAction } from '@/discipline-Manager/discipline-manger-hook';
