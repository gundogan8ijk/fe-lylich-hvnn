                ...
                <div className="flex-1 min-w-0 space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <Button variant="outline" size="sm" className="gap-2"
                            hidden={!data.permissions.canUpdateBase} onClick={() => {
                ...
                <div className="border border-slate-100 dark:border-slate-800 rounded-xl p-5 space-y-4">
                    <div className="flex items-center justify-between gap-4 flex-wrap">
                        ...
                        {perm?.canUpdateBase && base?.disciplines && base.disciplines.length < (perm.maxDisciplines ?? 5) && (
                            <Button onClick={() => {
                                openModal(MODAL_Manger_detail_PROJECT_KEYS.ADD_DISCIPLINE);
                            }}
                                variant="ghost" size="sm" className="h-8 gap-1 text-xs text-indigo-600 hover:text-indigo-700 dark:text-indigo-400">
