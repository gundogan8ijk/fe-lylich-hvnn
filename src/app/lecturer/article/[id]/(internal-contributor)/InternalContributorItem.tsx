            ...
            <div className="flex items-center gap-4 flex-1 min-w-0">
                ...
                <div className="space-y-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="inline-flex px-2 py-0.5 bg-blue-50 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300 text-xs font-mono rounded-md border border-blue-100">{contributor.code}</span>
                        {isCreator && (
