...
import { ArticleMangerItemResponse } from '@/working-manager/article/article-manager-type'
import { ConfirmedStatus } from '@/_constants/base-constant'

type ArticleManagerCardProps = {
    item: ArticleMangerItemResponse
    onViewDetail: (id: string) => void
}

export default function ArticleManagerCard({
    item,
    onViewDetail,
}: ArticleManagerCardProps) {
